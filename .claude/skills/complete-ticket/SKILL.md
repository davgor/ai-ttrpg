...
## 4b. Red team review before close-out

Before moving the ticket to `done/` / calling work merge-ready, run
`.cursor/skills/red-team-review/SKILL.md`, post on the PR with
`<!-- red-team-review -->`, and fix every **Blocking** finding (including
agent-authored PRs). Pure docs typo-only changes may skip when noted.
